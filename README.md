...
Data related to the manuscript entitled "Causal mediation for survival data: a unifying approach via GLM" (Taddeo &amp;  Amorim, 2022) published in the Revista Colombiana de Estadística - Applied Statistics, January 2022, volume 45, issue 1, pp. 1-412 (http://doi.org/10.15446/rce.v45n1.94553).  The R files replicate all data analyses presented in the manuscript. The data are drawn from Huang & Yang (2017), so please cite the original work if you ever use any of these data sets for research purposes. 
